 ...
 */
var MOBILE_EVENTS = ['touchstart', 'touchmove', 'touchend', 'touchcancel'];
...
AlloyFinger.prototype = {
    start: function (evt) {
        ...
        var touches = evt.targetTouches || evt.touches;
        ...
        this.x1 = touches[0].pageX;
        this.y1 = touches[0].pageY;
        ...
        if (len > 1) {
            ...
            var v = { x: touches[1].pageX - this.x1, y: touches[1].pageY - this.y1 };
            preV.x = v.x;
            preV.y = v.y;
    ...
    move: function (evt) {
        ...
        this.isDoubleTap = false;
        if (len > 1) {
            var sCurrentX = touches[1].pageX,
                sCurrentY = touches[1].pageY
            var v = { x: touches[1].pageX - currentX, y: touches[1].pageY - currentY };
